...
export const metadata: Metadata = {
  title: "AdeptNow Techno Solutions | Digital Excellence in Pharma & Life Sciences",
  description: "Specialized digital transformation partner for pharmaceutical and life sciences. GxP-compliant implementation, validation, and support services for LIMS, QMS, DMS, MES, SAP, and ERP systems.",
  keywords: [
  ...
  creator: "AdeptNow Techno Solutions",
  ...
  openGraph: {
    ...
    title: "AdeptNow Techno Solutions | Digital Excellence in Pharma & Life Sciences",
    description: "Specialized digital transformation partner for pharmaceutical and life sciences. GxP-compliant implementation, validation, and support.",
    images: [
      {
                ...
                "itemListElement": [
                  {
                    ...
                    "itemOffered": {
                      ...
                      "description": "End-to-end implementation services for LIMS, QMS, DMS, MES, SAP, and ERP systems"
                    }
                  },
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      ...
                      "description": "Strategic planning and risk mitigation for digitalization initiatives"
                    }
                  },
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      ...
                      "description": "Comprehensive master data services for GxP systems"
                    }
                  },
                  {
                    "@type": "Offer",
                    "itemOffered": {
                      ...
                      "description": "Strategic coordination between vendors, customers, and internal teams"
                    }
                  }
                ]
              }
